      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
            ...
            {displayItems.map((itemText, idx) => (
              <React.Fragment key={idx}>
                <span className="inline-flex items-center gap-2">
                  <span className="text-red-500 font-bold uppercase tracking-wider text-[11px]">
                    Victória D&D Soluções Imobiliárias:
                  </span>
                  {itemText}
                </span>
                <span className="text-red-500/50">•</span>
                <span className="text-slate-400">Atendimento oficial: Av. 21 de Janeiro, Luanda, Angola</span>
                <span className="text-red-500/50">•</span>
              </React.Fragment>
            ))}
          </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          <a
            id="marquee-btn-call"
            href={PHONE_TEL_LINK}
            className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-700 hover:border-red-500/40 text-[11px] font-medium transition-colors"
            title="Ligar Agora"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-emerald-950/80 hover:bg-emerald-900 text-emerald-300 border border-emerald-600/40 text-[11px] font-medium transition-colors"
